window.addEventListener("beforeunload", () => {
  localStorage.setItem("HI_PLATFORM_VANILLA_TEST_DATA", JSON.stringify(data));
});

function updateCheckboxState(selectorElement, value, indeterminate) {
  let checkbox = selectorElement.querySelector(
  ...
  checkbox.checked
    ...
    : selectorElement.classList.remove("selector--selected");

  checkbox.indeterminate
    ? selectorElement.classList.add("selector--indeterminate")
    : selectorElement.classList.remove("selector--indeterminate");

  let selectorBody = selectorElement.querySelector(".selector__body");

  if (!checkbox.indeterminate) {
    for (let child of selectorBody.children) {
      if (
        (checkbox.checked && !child.classList.contains("selector--selected")) ||
        (!checkbox.checked && child.classList.contains("selector--selected"))
      ) {
        updateCheckboxState(child, checkbox.checked, false);
      }
    }
  }
}

function updateParentSelectorState(selectorElement) {
  let selectorParent = selectorElement.parentElement.closest(".selector");

  if (selectorParent) {
    let hasUnselectedChildren = !!selectorParent.querySelector(
      `
        :scope > .selector__body > .selector:not(.selector--selected),
        :scope > .selector__body > .selector--indeterminate
      `
    );
    let hasSelectedChildren = !!selectorParent.querySelector(
      `
        :scope > .selector__body > .selector--selected,
        :scope > .selector__body > .selector--indeterminate
      `
    );
    ...
    updateParentSelectorState(selectorParent);
  }
}

function selectorClick(selectorElement) {
  let checkbox = selectorElement.querySelector(
    ".selector__header__left__checkbox-input"
  );

  updateCheckboxState(selectorElement, !checkbox.checked, false);
  updateParentSelectorState(selectorElement);
}

function toggleSelectorOpened(selectorElement, selectorObject) {
  selectorElement.classList.toggle("selector--opened");
  selectorObject.opened = !!selectorElement.classList.contains(
    "selector--opened"
  );
}

function renderSelectorGroup(selectorGroup, parentSelectorID) {
  let selectorsWrapper = document.querySelector(".selectors-wrapper");

  for (let index in selectorGroup) {
    let selectorObject = selectorGroup[index];

    let selector = document.createElement("div");
    selector.classList.add("selector");
    selector.id = selectorObject.id;
    if (!!parentSelectorID) {
      let parentSelector = document.getElementById(parentSelectorID);
      let parentSelectorBody = parentSelector.querySelector(".selector__body");
      parentSelectorBody.appendChild(selector);
    } else {
      selectorsWrapper.appendChild(selector);
    }

    let selectorHeader = document.createElement("div");
    selectorHeader.classList.add("selector__header");
    selectorHeader.style["padding-left"] = selectorObject.level * 25 + "px";
    selector.appendChild(selectorHeader);

    let selectorHeaderLeft = document.createElement("div");
    selectorHeaderLeft.classList.add("selector__header__left");
    selectorHeaderLeft.onclick = () => selectorClick(selector);
    selectorHeader.appendChild(selectorHeaderLeft);

    let selectorLeftCheckbox = document.createElement("div");
    selectorLeftCheckbox.classList.add("selector__header__left__checkbox");
    selectorHeaderLeft.appendChild(selectorLeftCheckbox);

    let selectorLeftCheckboxInput = document.createElement("input");
    selectorLeftCheckboxInput.classList.add(
      "selector__header__left__checkbox-input"
    );
    selectorLeftCheckboxInput.type = "checkbox";
    selectorLeftCheckboxInput.onchange = (e) =>
      (selectorObject.selected = e.target.checked);
    selectorLeftCheckbox.appendChild(selectorLeftCheckboxInput);

    let selectorLeftCheckboxLabel = document.createElement("label");
    selectorLeftCheckboxLabel.classList.add(
      "selector__header__left__checkbox-label"
    );
    selectorLeftCheckbox.appendChild(selectorLeftCheckboxLabel);

    let selectorHeaderLeftTitle = document.createElement("div");
    selectorHeaderLeftTitle.classList.add("selector__header__left__title");
    selectorHeaderLeftTitle.textContent = selectorObject.name;
    selectorHeaderLeft.appendChild(selectorHeaderLeftTitle);

    let objectChildrenLength = Object.keys(selectorObject.children).length;
    if (!!objectChildrenLength) {
      let selectorHeaderRight = document.createElement("div");
      selectorHeaderRight.classList.add("selector__header__right");
      selectorHeaderRight.onclick = () =>
        toggleSelectorOpened(selector, selectorObject);
      selectorHeader.appendChild(selectorHeaderRight);

      let selectorHeaderRightArrow = document.createElement("div");
      selectorHeaderRightArrow.classList.add("selector__header__right__arrow");
      selectorHeaderRight.appendChild(selectorHeaderRightArrow);
    }

    let selectorBody = document.createElement("div");
    selectorBody.classList.add("selector__body");
    ...
    renderSelectorGroup(selectorObject.children, selector.id);
  }
}

let data = JSON.parse(
  localStorage.getItem("HI_PLATFORM_VANILLA_TEST_DATA")
) || {
  0: {
    ...
    children: {
        ...
        children: {
          0: {
            ...
            children: {
              ...
              3: {
                id: "218e1ab3-191a-4301-a76d-2adfffd9e97f",
                name: "Élie Melvin",
                children: {},
                level: 3,
              },
              4: {
                id: "a97eda46-6220-44dd-8db1-e5116a71d57f",
                name: "Alvin E. Emil Theodor",
                children: {},
                level: 3,
              },
              5: {
                id: "cd781f42-19e5-4c2b-a000-67613e24bd15",
                name: "Heike Norman E.",
                children: {},
                level: 3,
              },
          ...
          1: {
            id: "5199b87a-a02e-4215-ac9e-dd5aee27fb10",
            name: "Kurt Dickinson W.",
            children: {
              0: {
                id: "8bb2d434-8e08-470f-afaa-709a1f15c542",
                name: "Christopher A. Sir James W.",
                children: {
                  0: {
                    id: "13e747fb-5d11-4e79-b068-ebd0f8541602",
                    name: "Camilo José Lech",
                    children: {},
                    level: 4,
                  },
                },
              ...
              1: {
                id: "e28db777-45aa-4cb4-82ee-c104099f7c81",
                name: "John B. Heinrich",
                children: {},
                level: 3,
              },
              2: {
                id: "190514f6-ad74-42d0-bf80-53e131e0c630",
                name: "Thomas Stearns Charles Louis Alphonse",
                children: {},
                level: 3,
              },
              3: {
                id: "d9f68330-cb70-4c43-84b4-16d1dba3e968",
                name: "Heike Carl E.",
                children: {},
                level: 3,
              },
              4: {
                id: "a7d64d09-bdb7-4809-a121-253e722da529",
                name: "Martin Tasuku",
                children: {},
                level: 3,
              },
          ...
          2: {
            id: "1622fb37-70ca-4380-a1d4-110506276c50",
            name: "Finn E. May-Britt",
            children: {
              0: {
                id: "e16f7f7b-daea-4756-9605-105c8f5d02e2",
                name: "James Watson Saul",
                children: {},
                level: 3,
              },
              1: {
                id: "5401a9ce-a959-4967-a1c6-f90b1657d121",
                name: "Shinya Hideki",
                children: {},
                level: 3,
              },
              2: {
                id: "b2768f11-12d7-4de4-80f5-9cc2b9161bec",
                name: "Konrad Edwin Mattison",
                children: {},
                level: 3,
              },
              3: {
                id: "8ec94526-47dd-48d1-8b4b-4fccea0bbbf0",
                name: "Ernst Boris Douglass C.",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "9b594836-6728-4c3b-801a-160c3317d64d",
            name: "James A. Shimon",
            children: {
              0: {
                id: "1d2f2a46-4f72-4e8b-a666-5cad01927c88",
                name: "Martti Arthur",
                children: {},
                level: 3,
              },
              1: {
                id: "b3080174-eb31-41c9-bedd-1a7e6f7c73ae",
                name: "Melvin Selma Ottilia Lovisa",
                children: {},
                level: 3,
              },
              2: {
                id: "09af712a-e1ec-4061-a37d-c1b2ba52dc70",
                name: "Julius George Richards",
                children: {},
                level: 3,
              },
            },
          ...
          4: {
            id: "5d2d7c9b-9b46-4c01-9e2e-3b437517d0e6",
            name: "Jaroslav Bertram N.",
            children: {
              0: {
                id: "f68b11e7-eb0d-495b-8614-5950969a6e86",
                name: "Alan J. J. Robin",
                children: {},
                level: 3,
              },
              1: {
                id: "e1e2a188-834e-4d80-ac2c-d6e2833744b2",
                name: "David Odysseus",
                children: {},
                level: 3,
              },
          ...
          5: {
            id: "2b9cbb54-b74f-4c35-8dcf-962a3e61b48e",
            name: "Johannes Henrik",
            children: {
              0: {
                id: "59adcb35-6eea-4c12-a3e7-6c3fd8cb0577",
                name: "Herbert Paul Henri Benjamin Balluet",
                children: {},
                level: 3,
              },
              1: {
                id: "4ec444ca-95ad-4d6d-ae85-b9610a466d0d",
                name: "Elizabeth H. Arthur",
                children: {},
                level: 3,
              },
            },
          ...
          6: {
            id: "579e8f4b-4368-4d1d-a0ad-bfea2b8a9ed2",
            name: "Emil Theodor William Bradford",
            children: {
              0: {
                id: "dd09d33b-f413-454e-a5a2-8e96ffe72aa6",
                name: "Ernest Orlando Thomas C.",
                children: {},
                level: 3,
              },
            },
          ...
          7: {
            id: "5b8c4aa5-8253-43bf-a22e-6c59b0a3f91e",
            name: "Martin Jean-Marie Gustave",
            children: {
              0: {
                id: "18f9326d-e8c1-4eea-9fde-01942b7781cb",
                name: "Yoichiro Melvin",
                children: {},
                level: 3,
              },
            },
          ...
          8: {
            id: "7a48fe5c-8881-432a-9a3a-9b0454fffa66",
            name: "Theodore W. Ada E.",
            children: {},
            level: 2,
          },
          9: {
            id: "5f259753-b1a7-4a73-808d-131024e5db32",
            name: "Joseph E. Louis",
            children: {},
            level: 2,
          },
          10: {
            id: "9524c8ec-473c-49b0-9791-d741f1a6a632",
            name: "Paul D. Sigrid",
            children: {},
            level: 2,
          },
          11: {
            id: "612d5c9d-458e-470b-96a2-04b0b75cce4d",
            name: "Douglass C. Paul",
            children: {},
            level: 2,
          },
          12: {
            id: "0d769032-f9d5-47ca-a02d-a05c3998144f",
            name: "Lars Pablo",
            children: {},
            level: 2,
          },
      ...
      1: {
        id: "80f76631-f757-4fa4-96da-d62a13e93711",
        name: "National Dialogue Quartet George",
        children: {
          0: {
            id: "54214d4f-e542-4373-b707-9a6903cf005d",
            name: "Herbert Spencer Hans",
            children: {
              0: {
                id: "e737d1c3-e1dc-43c3-a2c4-a435fc708108",
                name: "Rudyard Max",
                children: {
                  0: {
                    id: "537f1ad8-eccc-43b1-994f-e56093258fc0",
                    name: "Hannes Olof Gösta Masatoshi",
                    children: {},
                    level: 4,
                  },
                },
              ...
              1: {
                id: "f28c006f-a8f5-4892-a2d3-53c6973b1826",
                name: "Hermann Melvin",
                children: {},
                level: 3,
              },
              2: {
                id: "ec655106-75d5-45a1-98a3-43808f9872d3",
                name: "Robert M. César",
                children: {},
                level: 3,
              },
              3: {
                id: "f12bfd2a-71f3-4350-88e3-ad74b1e82495",
                name: "Boris Leonidovich Frank",
                children: {},
                level: 3,
              },
              4: {
                id: "0f88498f-1b10-42e1-a44b-537f424e975d",
                name: "Makoto John Robert",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "000c8d17-a6f9-495e-b679-2b614e007cac",
            name: "Sir Charles Scott Richard R.",
            children: {
              0: {
                id: "543c0e6b-5cd6-4cfa-b411-422d81d15790",
                name: "Finn E. Ivo",
                children: {},
                level: 3,
              },
              1: {
                id: "64bd3c5f-6430-41f5-bb07-3eb8861b943f",
                name: "Baruj Randy W.",
                children: {},
                level: 3,
              },
              2: {
                id: "f0fd1f1b-2bbc-4d73-be8c-c5fd854cb56f",
                name: "Geoffrey Owen",
                children: {},
                level: 3,
              },
              3: {
                id: "caa13699-4f9c-4480-8616-b71a9d9989a4",
                name: "Eugenio Alfonso",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "d6778c73-b45d-4eba-abed-19918f5eff7c",
            name: "Doris J. Michael",
            children: {
              0: {
                id: "eaaa3469-3df8-46fc-855f-94953233230e",
                name: "Makoto Henri",
                children: {},
                level: 3,
              },
              1: {
                id: "642df084-6f1d-45e0-8c1c-f52d40320c07",
                name: "Ernst Otto Artturi Ilmari",
                children: {},
                level: 3,
              },
              2: {
                id: "c33106cf-2167-4dfc-8c26-1f8e7d1b8801",
                name: "Richard R. Rigoberta",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "99971f32-20b7-4b96-859f-e8fa4c6d7b5d",
            name: "Georg Luis F.",
            children: {
              0: {
                id: "07927191-6b38-487d-979e-33e6268ebb03",
                name: "Max Karl Ernst Ludwig E. Donnall",
                children: {},
                level: 3,
              },
              1: {
                id: "20e22ccc-2158-471e-84e9-6afbbdbe2b9a",
                name: "John E. James E.",
                children: {},
                level: 3,
              },
          ...
          4: {
            id: "3ff1b4f5-3533-4701-bbd5-e13a390d8fed",
            name: "Albert Abraham Alfred G.",
            children: {
              0: {
                id: "85b3e08e-aa49-4584-bf8d-b3b3eff01674",
                name: "Juan Manuel Carol W.",
                children: {},
                level: 3,
              },
              1: {
                id: "00afb885-03f0-4eae-96ec-37b97324071f",
                name: "Ragnar Giosuè",
                children: {},
                level: 3,
              },
          ...
          5: {
            id: "f8220ed8-df11-4d11-87fe-9db3d7485d6a",
            name: "Carlo Hermann Joseph",
            children: {
              0: {
                id: "0606421c-4cd6-4493-b8d4-c1664cb8dc1d",
                name: "Charles Glover Makoto",
                children: {},
                level: 3,
              },
            },
          ...
          6: {
            id: "90a0009b-9e8a-45d1-8e02-b381aa1d6e3c",
            name: "Sir John Carew Daniel",
            children: {
              0: {
                id: "c2078cf4-924d-4fe7-b6f8-8bdee70c049e",
                name: "Naguib Jack W.",
                children: {},
                level: 3,
              },
          ...
          7: {
            id: "eb28baf4-78ac-461b-8d23-4c75ba59e532",
            name: "Paul M. Robert C.",
            children: {},
            level: 2,
          },
          8: {
            id: "0ebd64ce-8bac-46ac-80af-2191adf91e4b",
            name: "Thomas C. Earl (Bertrand Arthur William)",
            children: {},
            level: 2,
          },
          9: {
            id: "37227c6f-115f-4c34-bc77-9e98107abb9d",
            name: "Eugene F. Renato",
            children: {},
            level: 2,
          },
          10: {
            id: "274ef6af-33ad-4257-b6c8-fc356422a495",
            name: "Edward Adelbert Derek H. R.",
            children: {},
            level: 2,
          },
          11: {
            id: "d4d7b4f0-1505-4658-9b70-91c40b058b40",
            name: "Lawrence R. Amartya",
            children: {},
            level: 2,
          },
        },
      ...
      2: {
        id: "f1f604bf-02b3-4ea6-b047-0f0804f4477c",
        name: "Roger Y. Robert C.",
        children: {
          0: {
            id: "b6d1643d-dd9d-4b28-92dd-c899a1be20d8",
            name: "Wole Glenn Theodore",
            children: {
              0: {
                id: "cad0f3f7-a28b-498c-b9e5-d8245499d434",
                name: "Vincent Kenneth J.",
                children: {},
                level: 3,
              },
              1: {
                id: "a4b7fa34-20e5-4ae3-a532-52b3caec84f7",
                name: "Léon H. David",
                children: {},
                level: 3,
              },
              2: {
                id: "f52e9136-6153-4887-a87e-7cb70c8af8c9",
                name: "Marshall W. Percy Williams",
                children: {},
                level: 3,
              },
              3: {
                id: "893392e8-d93b-44ef-9b38-90ba58d89e06",
                name: "Joseph Nicolay Gennadiyevich",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "01b79bad-8bfe-4506-be43-6eb59a5af63b",
            name: "Martin Adolfo",
            children: {
              0: {
                id: "91fcfc83-76b2-4e7f-8006-5a23d3284729",
                name: "Peyton Christian B.",
                children: {},
                level: 3,
              },
              1: {
                id: "02757eaf-bf35-42cb-a2d5-9c70101260c7",
                name: "Baroness Bertha Sophie Felicita William",
                children: {},
                level: 3,
              },
              2: {
                id: "3996df98-81ef-4bd8-8eaf-59ece20836da",
                name: "Giulio Denis",
                children: {},
                level: 3,
              },
          ...
          2: {
            id: "c429ef15-5cf4-4514-be8e-cb7edb54f798",
            name: "Axel Hugo Theodor Hartmut",
            children: {
              0: {
                id: "ad964479-8a90-4f67-a6d4-3e7b9e0fcaa8",
                name: "Kenneth G. William N.",
                children: {},
                level: 3,
              },
              1: {
                id: "7114f844-c227-4d89-b10b-6975f5ece38f",
                name: "Charles Glover Thomas",
                children: {},
                level: 3,
              },
              2: {
                id: "2630908c-9eba-49f1-9058-84a3e54594ce",
                name: "Mairead Martin L.",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "f375943d-642d-4ca2-8f02-098549dab882",
            name: "Shimon Antoine Henri",
            children: {
              0: {
                id: "d1d04482-338f-478a-a4fc-3c371efd9032",
                name: "Ernesto Teodoro Yasunari",
                children: {},
                level: 3,
              },
              1: {
                id: "c6ff0536-7e36-4505-ba51-dc90aeb26ef2",
                name: "Roger Werner",
                children: {},
                level: 3,
              },
          ...
          4: {
            id: "8c027889-4478-45da-b41f-2884cfd01819",
            name: "Georges Richard Laurence Millington",
            children: {
              0: {
                id: "c14264cd-342a-484c-a6bc-c61687170942",
                name: "Paul J. Henrik Carl Peter",
                children: {},
                level: 3,
              },
            },
          ...
          5: {
            id: "704dafb8-6103-49b5-b689-47fd7e820604",
            name: "Arno Allan Seán",
            children: {
              0: {
                id: "bd54ab3a-16c1-4f82-b660-c6fb85c8cab4",
                name: "Edward Lawrie William F.",
                children: {},
                level: 3,
              },
            },
          ...
          6: {
            id: "b1bea054-870a-44b9-bf15-090814fccc04",
            name: "Steven Finn E.",
            children: {},
            level: 2,
          },
          7: {
            id: "cc9862be-0c80-4cd8-a883-da3db19f57ce",
            name: "Chen Ning André Frédéric",
            children: {},
            level: 2,
          },
          8: {
            id: "36b52baa-6491-4d7b-99a3-3e52e4dd5adc",
            name: "Leonid Fritz",
            children: {},
            level: 2,
          },
          9: {
            id: "d0bb7736-8b56-49a4-b114-213b25130558",
            name: "Leland H. Elfriede",
            children: {},
            level: 2,
          },
          10: {
            id: "6a3f104d-bc53-4142-a27a-dc2c2d9b108c",
            name: "Sir Paul M. Romain",
            children: {},
            level: 2,
          },
        },
      ...
      3: {
        id: "05004e31-1edd-4c2c-acd2-d32e0a6d8fdd",
        name: "K. Alexander Milton",
        children: {
          0: {
            id: "52b2d54e-2e71-4040-9c1e-6954a6546c51",
            name: "Henry W. William Parry",
            children: {
              0: {
                id: "1f6309a5-bdc7-4e72-bf9e-992b2f604193",
                name: "Wolfgang Albert",
                children: {},
                level: 3,
              },
              1: {
                id: "01c38bb6-9300-49b7-b2f2-6253603e2bcd",
                name: "Vitaly L. Johannes Diderik",
                children: {},
                level: 3,
              },
              2: {
                id: "ab435a12-dde5-452a-87e1-2733af048bd2",
                name: "Nelly Wislawa",
                children: {},
                level: 3,
              },
          ...
          1: {
            id: "c8aa2bad-46fa-4003-b932-49de100d204b",
            name: "George F. Reinhard",
            children: {
              0: {
                id: "9688edb7-f615-4fc1-be4b-0d45ca868e8d",
                name: "Jerome I. Hannes Olof Gösta",
                children: {},
                level: 3,
              },
              1: {
                id: "ff87d89c-b610-49bd-92c2-a7c1a24eeb58",
                name: "Osamu Juan Ramón",
                children: {},
                level: 3,
              },
              2: {
                id: "9d8f5082-fbfa-44dd-a208-089626c49d63",
                name: "Paul A. Charles Kuen",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "8f281110-3e33-4fdf-b12b-7a68ed66c8e3",
            name: "Sir Gregory P. Rita",
            children: {
              0: {
                id: "821325fb-e8bc-4338-91a7-b57d8e3545a0",
                name: "J. Michael Karl Adolph",
                children: {},
                level: 3,
              },
              1: {
                id: "d58d4167-17b5-44f0-b76e-2ef211f29657",
                name: "Avram Pierre-Gilles",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "c3b05263-ebf3-4b1c-a670-f84d7b6ec87c",
            name: "Elias Karl",
            children: {
              0: {
                id: "30ce458d-d22e-4c4a-9e75-2f38ffd4da05",
                name: "Albert Gérard",
                children: {},
                level: 3,
              },
          ...
          4: {
            id: "a4941ade-7e93-4435-9765-e4b16d483b31",
            name: "Gérard Martti",
            children: {
              0: {
                id: "61794ade-85f9-474c-b916-b86f4657cb71",
                name: "Ernst Boris Daniel",
                children: {},
                level: 3,
              },
            },
          ...
          5: {
            id: "a269e3d8-703c-444b-8c67-80c9805bf214",
            name: "Wilhelm Paul",
            children: {},
            level: 2,
          },
          6: {
            id: "b8deec23-2823-463c-8676-69d1c9de90a1",
            name: "John A. Makoto",
            children: {},
            level: 2,
          },
          7: {
            id: "fa06715d-c275-4493-958e-08f5c6c3e7f1",
            name: "J. Robin Gabriel",
            children: {},
            level: 2,
          },
          8: {
            id: "5f2d0c41-0a0e-43b8-829a-d0baec2ca77c",
            name: "D. Carleton Wangari Muta",
            children: {},
            level: 2,
          },
          9: {
            id: "1b1bcdbb-0d09-42aa-925a-3738ce798d96",
            name: "John C. Zhores I.",
            children: {},
            level: 2,
          },
        },
      ...
      4: {
        id: "d3a41339-d379-404b-b581-8fc72ef2e28d",
        name: "Baruch S. Andre",
        children: {
          0: {
            id: "db66c3bc-9dc8-48d2-be21-240cf54f6aa4",
            name: "Jimmy Wladyslaw Stanislaw",
            children: {
              0: {
                id: "335f348a-08a2-4a61-97a3-68f26e476a0f",
                name: "Yuan T. Arne Wilhelm Kaurin",
                children: {},
                level: 3,
              },
              1: {
                id: "dec4564d-5fae-4305-9c5b-4a3ee2a6b34f",
                name: "Mairead Ernest Orlando",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "2bd3e2c6-7f50-4f89-9b29-fd8547605283",
            name: "Riccardo Simon",
            children: {
              0: {
                id: "8471e13a-f388-4cd1-a67b-25558b048c51",
                name: "Riccardo Karl",
                children: {},
                level: 3,
              },
              1: {
                id: "4569adf0-2126-4ba6-824e-372d5828c1a6",
                name: "Il´ja Mikhailovich Peter D.",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "fdcccc69-1b9e-4373-a809-26fb848f5a57",
            name: "Odd Ronald H.",
            children: {
              0: {
                id: "4d146af9-231b-4f6c-b57a-c77a79501297",
                name: "Gerhard Edwin G.",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "6343dbd1-3357-4c6b-b488-3ef03f65fe31",
            name: "Axel Hugo Theodor Robert Bruce",
            children: {
              0: {
                id: "7fbea304-ae87-4785-8dae-1c3074829798",
                name: "Antoine Henri Victor Franz",
                children: {},
                level: 3,
              },
            },
          ...
          4: {
            id: "d05a4c50-4b2e-4371-812b-8fc81cf2c0c6",
            name: "Takaaki Michael W.",
            children: {},
            level: 2,
          },
          5: {
            id: "0343785e-2b5a-4e11-b701-a392a0f7f31d",
            name: "Knut Pedersen Hermann",
            children: {},
            level: 2,
          },
          6: {
            id: "688a30ea-144f-4385-9b4f-5ad92615de04",
            name: "Andre Trygve",
            children: {},
            level: 2,
          },
          7: {
            id: "98388d46-85e7-4c98-9dbe-1295d074444d",
            name: "Sir Winston Leonard Spencer Walther",
            children: {},
            level: 2,
          },
          8: {
            id: "a7881b60-5afd-407f-b4f5-e4e05596713a",
            name: "Emil Adolf Alvin E.",
            children: {},
            level: 2,
          },
        },
      ...
      5: {
        id: "43c75703-19d5-4cc9-83c3-cbd734940c8e",
        name: "Harold E. Makoto",
        children: {
          0: {
            id: "a679cb5b-96ff-4d33-b986-01e3975f7d28",
            name: "William Lawrence Riccardo",
            children: {
              0: {
                id: "776a425d-24a2-451a-a4f3-0e7b70440bea",
                name: "Venkatraman Ryoji",
                children: {},
                level: 3,
              },
              1: {
                id: "76e7e24f-ef21-48a4-bc47-813ae1e26421",
                name: "Wolfgang Hannes Olof Gösta",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "0d007225-5f2f-46a2-bb58-e88b046b446b",
            name: "Bernardo Alberto Gustav",
            children: {
              0: {
                id: "ed47f86c-cf58-4f09-979e-12020d6ea58b",
                name: "Albrecht Eric S.",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "558b504a-473c-4963-9980-6bc9268f2ba4",
            name: "Adam G. Burton",
            children: {
              0: {
                id: "10d2760a-c58b-4704-8c87-02092573c667",
                name: "Thomas Huckle Nadine",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "9aa1e749-bec0-433d-98e0-6df046667e8d",
            name: "Jean Luigi",
            children: {},
            level: 2,
          },
          4: {
            id: "a35b2b67-d587-4356-94e5-9bd4c6ad779e",
            name: "Gerard Carl",
            children: {},
            level: 2,
          },
          5: {
            id: "372fd2f0-41df-4221-b7fc-6e9582aab412",
            name: "Finn E. Daniel",
            children: {},
            level: 2,
          },
          6: {
            id: "8ce3bb42-f39d-4797-ba80-064bbbe8e329",
            name: "Jimmy Aage Niels",
            children: {},
            level: 2,
          },
          7: {
            id: "ba4a8165-a3b5-4a02-8a09-790c691741dc",
            name: "Thomas Woodrow Shirin",
            children: {},
            level: 2,
          },
        },
      ...
      6: {
        id: "ade91847-b42b-4712-9a2a-35a4fcd729de",
        name: "William Parry Paul",
        children: {
          0: {
            id: "77617ee9-c79b-4100-8c7c-55a7554d0ba4",
            name: "Friends Service Council (The Quakers) William",
            children: {
              0: {
                id: "3151c878-b983-4dc8-9aaf-6ab66bc77b9b",
                name: "Joachim Lord (Alexander R.)",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "83804085-c16e-4435-90dc-d3c101fc2494",
            name: "Günter Michael",
            children: {
              0: {
                id: "f8d41bf0-2bfb-459f-869c-6b0fcb314bb3",
                name: "Gerhard Gunnar",
                children: {},
                level: 3,
              },
          ...
          2: {
            id: "d2d87abb-a552-4169-995d-c540e6905929",
            name: "Yves Derek H. R.",
            children: {
              0: {
                id: "04ec55d3-6097-46af-807e-4f79451c7dd3",
                name: "Richard Theodor W.",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "b4800c9d-15c2-411a-a0ed-a37c6b48b299",
            name: "Konstantin Sir Arthur",
            children: {},
            level: 2,
          },
          4: {
            id: "d99dc117-196e-4bb5-9459-3fdb065c8240",
            name: "Albert Jody",
            children: {},
            level: 2,
          },
          5: {
            id: "005d4a30-770d-4fef-877c-7473d13b2794",
            name: "Elias James George Catlett",
            children: {},
            level: 2,
          },
          6: {
            id: "c41a9147-3037-44a8-af0d-1fcebea48a91",
            name: "Douglas D. Jean Baptiste",
            children: {},
            level: 2,
          },
        },
      ...
      7: {
        id: "31983867-2f85-447e-bbda-1292a9c418a2",
        name: "Frédéric Robert Woodrow",
        children: {
          0: {
            id: "8b1f29ac-eb45-4a20-8d7a-230c23a9aad7",
            name: "Ronald George Wreyford Owen Willans",
            children: {
              0: {
                id: "418cab80-06f6-4c61-a5bf-f2221bb17a75",
                name: "Georges Robert C.",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "5040e364-ddc2-49bc-808e-459979dd90d8",
            name: "James A. J. Michael",
            children: {},
            level: 2,
          },
          2: {
            id: "e00d316e-88ce-4581-b64b-0efd200b6bc5",
            name: "Sir John B. Satoshi",
            children: {},
            level: 2,
          },
          3: {
            id: "c66db215-b302-4369-a82e-da720fac320c",
            name: "Gerty Theresa Alice",
            children: {},
            level: 2,
          },
          4: {
            id: "0faa40d4-80e8-4d68-958a-965aeab4d2e8",
            name: "Claude Rabindranath",
            children: {},
            level: 2,
          },
          5: {
            id: "a02fcf2c-6420-4410-b2bb-5a50f566be8e",
            name: "Oliver E. Craig C.",
            children: {},
            level: 2,
          },
        },
      ...
      8: {
        id: "fd334f43-b6de-48eb-9341-72484c330d30",
        name: "Camilo José John C.",
        children: {
          0: {
            id: "022e42d0-3c9c-4c09-abe4-0b849ed4346f",
            name: "Louis Eugène Félix Erwin",
            children: {
              0: {
                id: "b770ed03-3f68-4056-a4da-068c87518f38",
                name: "Baruj Hans Adolf",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "d14fca68-b7b4-414d-a44e-241008f7eb74",
            name: "Robert C. Avram",
            children: {},
            level: 2,
          },
          2: {
            id: "d62a5ea9-8236-42b9-b140-ad6473abddcd",
            name: "Carol W. D. Carleton",
            children: {},
            level: 2,
          },
          3: {
            id: "8cec00e0-0eb4-4e38-81f9-074eaea42e39",
            name: "Clive W.J. Jacques",
            children: {},
            level: 2,
          },
          4: {
            id: "bc8a0b91-73dc-416f-a272-f73acf35926f",
            name: "Elihu Gary S.",
            children: {},
            level: 2,
          },
      ...
      9: {
        id: "9214e89e-15a8-4f95-8c02-fbfd7b010173",
        name: "Johannes Bertram N.",
        children: {
          0: {
            id: "c65f85e3-163e-4f36-9c6e-07fed69865b4",
            name: "Sir Arthur Enrico",
            children: {},
            level: 2,
          },
          1: {
            id: "1e02b399-9f82-41d9-a463-ea74b04e3bcd",
            name: "Sir Frederick Gowland George",
            children: {},
            level: 2,
          },
          2: {
            id: "07128937-1fdd-4c7d-b7d2-3e2466c9276f",
            name: "Richard Laurence Millington Arthur B.",
            children: {},
            level: 2,
          },
          3: {
            id: "967e2f44-b240-4aa0-9e32-92185926cd4e",
            name: "Gabriela Jacques",
            children: {},
            level: 2,
          },
        },
      ...
      10: {
        id: "2ae4de27-5394-484f-81ce-00e04ecdaddb",
        name: "Eugene F. Jerome",
        children: {
          0: {
            id: "a4c519c1-2505-42b9-b7b9-5b8ec7e33bb8",
            name: "Otto James E.",
            children: {},
            level: 2,
          },
          1: {
            id: "35ca43b9-1d00-47b9-ad58-c1661e726ae5",
            name: "Robert G. Edwin Mattison",
            children: {},
            level: 2,
          },
          2: {
            id: "eabc1f40-0efe-4ab4-9eaf-3f8dd15cc24b",
            name: "Sir Winston Leonard Spencer Louis J.",
            children: {},
            level: 2,
          },
        },
      ...
      11: {
        id: "601b90f2-ec5d-401a-b0e6-45456cd4d974",
        name: "Michael Sir Arthur",
        children: {
          0: {
            id: "528b5516-1cdc-4f57-9e14-debc057bbcdd",
            name: "John Warcup Peter C.",
            children: {},
            level: 2,
          },
          1: {
            id: "d6b0c122-0105-4503-a460-2f724e56139f",
            name: "Rudolph A. John Robert",
            children: {},
            level: 2,
          },
          2: {
            id: "f1caafc0-29bd-49f6-aa41-a21ac7b4103a",
            name: "Samuel Richard P.",
            children: {},
            level: 2,
          },
        },
      ...
      12: {
        id: "19acd3df-888f-425b-950f-664edeb50745",
        name: "Angus Wilhelm",
        children: {
          0: {
            id: "0969b89d-2f3c-4b74-a2f8-5309aec1f051",
            name: "Lev Davidovich Craig C.",
            children: {},
            level: 2,
          },
          1: {
            id: "ed6ca250-60f3-426b-ad22-0aa5d77b74a5",
            name: "George Robert Woodrow",
            children: {},
            level: 2,
          },
        },
      ...
      13: {
        id: "877c6e7e-c1b8-45b1-a261-59bd364f2897",
        name: "Hiroshi Jacinto",
        children: {
          0: {
            id: "31f0c4ce-1fa4-4677-ac35-b845434ebe38",
            name: "Wislawa Thomas Stearns",
            children: {},
            level: 2,
          },
        },
      ...
      14: {
        id: "df7bfceb-1ac5-4a1e-989d-abad3643f450",
        name: "Ronald H. Ernest Miller",
        children: {
          0: {
            id: "1b7bf114-2286-43a3-9ae7-a1c08ca76aeb",
            name: "Betty Eric S.",
            children: {},
            level: 2,
          },
      ...
      15: {
        id: "599dc914-535b-486a-ada3-e14eeae42413",
        name: "Aaron Samuel Chao Chung",
        children: {},
        level: 1,
      },
      16: {
        id: "d23c1af1-fa83-4903-925a-c6e23e6aceaf",
        name: "Kofi Wendell Meredith",
        children: {},
        level: 1,
      },
      17: {
        id: "90bb419b-115e-4a7b-95b2-c079c9daf3aa",
        name: "Paul A. James J.",
        children: {},
        level: 1,
      },
      18: {
        id: "ef294ac8-e17c-4e25-82c1-5ba96b5b164a",
        name: "Carlo Herbert C.",
        children: {},
        level: 1,
      },
      19: {
        id: "bfa1fb2f-0205-4407-ab30-66c0acb8a1d6",
        name: "Osamu Harald",
        children: {},
        level: 1,
      },
  ...
  1: {
    id: "38ede235-7ad0-4780-b61b-974953e374b9",
    name: "William D. Yasunari",
    children: {
      0: {
        id: "5b60ebf2-8c9f-4398-baef-58f7c9c34f5f",
        name: "Paul Burton",
        children: {
          0: {
            id: "78f26b44-bb92-492f-98ad-68b72c5f2fd2",
            name: "Henrik Carl Peter Stanford",
            children: {
              0: {
                id: "567be87c-3873-44de-90c0-45bcf29a6118",
                name: "John Hasbrouck Gerhard",
                children: {
                  0: {
                    id: "aae1331b-e255-4185-9e1e-2ad2a4dc0795",
                    name: "Feodor John B.",
                    children: {},
                    level: 4,
                  },
              ...
              2: {
                id: "c108ade5-a117-46b9-b7ce-fceade8c22be",
                name: "Baroness Bertha Sophie Felicita Torsten N.",
                children: {},
                level: 3,
              },
              3: {
                id: "e692e7b7-96fa-4179-a491-f81ff3702d2e",
                name: "Denis George P.",
                children: {},
                level: 3,
              },
              4: {
                id: "e7d25f05-f98e-44e0-a9f0-07e8e37ee35e",
                name: "Dario Georg",
                children: {},
                level: 3,
              },
          ...
          1: {
            id: "5da13ae5-7d07-480b-8076-3dbf1c996fb7",
            name: "Alfred D. Czeslaw",
            children: {
              0: {
                id: "75c38785-5513-4dde-a967-cd606d7c1f5b",
                name: "Charles Kuen J. Robin",
                children: {},
                level: 3,
              },
              1: {
                id: "84dfb92c-404d-4568-a431-e2a6b7068206",
                name: "Michael S. Odysseus",
                children: {},
                level: 3,
              },
              2: {
                id: "452e6040-eb30-455d-a1d6-241de89f3e9a",
                name: "Dickinson W. Kary B.",
                children: {},
                level: 3,
              },
              3: {
                id: "0410e1cb-26e8-4de0-a7e7-62e87a90b816",
                name: "Ilya Gerard",
                children: {},
                level: 3,
              },
          ...
          2: {
            id: "3324d37f-2e48-4227-bac4-b00740dbd77b",
            name: "Artturi Ilmari Jerome",
            children: {
              0: {
                id: "527d7b46-d906-4b39-8225-679e651ba7aa",
                name: "Arthur Leonard Harold",
                children: {},
                level: 3,
              },
              1: {
                id: "a8b7b859-7621-4ef9-9190-45a11cda9642",
                name: "Reinhard Walter Rudolf",
                children: {},
                level: 3,
              },
              2: {
                id: "f19aee18-3b5f-4883-83f3-66fb1fbfb7cf",
                name: "Gérard Gabriel",
                children: {},
                level: 3,
              },
          ...
          3: {
            id: "ba484ac4-d3ed-4dbc-8ba8-6c9096b72755",
            name: "Ahmed H. Pierre-Gilles",
            children: {
              0: {
                id: "c00488f3-896b-428a-a63d-db32280f15b0",
                name: "Odd Tjalling C.",
                children: {},
                level: 3,
              },
              1: {
                id: "9dd0094a-3291-4d7d-a957-fb48ebb085ba",
                name: "Henri Bruce A.",
                children: {},
                level: 3,
              },
          ...
          4: {
            id: "5cbb783d-ffb9-4a54-96c0-51a7d1572b21",
            name: "Hamilton O. H. Robert",
            children: {
              0: {
                id: "79ab513c-abce-43d4-b821-ac2bbf6f1cd1",
                name: "Reinhard Herbert A.",
                children: {},
                level: 3,
              },
              1: {
                id: "574a148e-764f-41db-b8d8-7690eeb335b6",
                name: "Gabriela Alfred Hermann",
                children: {},
                level: 3,
              },
            },
          ...
          5: {
            id: "0abc3b82-1924-49b2-b6aa-d5c34c96d4ad",
            name: "Albrecht Johann Friedrich Wilhelm Adolf",
            children: {
              0: {
                id: "6f7d9b70-6043-4da5-a134-3edb52012624",
                name: "Saul H. David",
                children: {},
                level: 3,
              },
          ...
          6: {
            id: "9de0be08-62a9-46af-95d1-a5f1de8aa5d8",
            name: "George F. Heinrich",
            children: {
              0: {
                id: "1e4d4bd1-b6a1-445e-b919-edc991f009b5",
                name: "Hans Hamilton O.",
                children: {},
                level: 3,
              },
            },
          ...
          7: {
            id: "d3689401-3047-46be-9bdb-6b5616011120",
            name: "Luigi Alan G.",
            children: {},
            level: 2,
          },
          8: {
            id: "a3d3dc7c-ff1b-460c-a66d-f9f743c76ff5",
            name: "Lord (Alexander R.) Sir Alexander",
            children: {},
            level: 2,
          },
          9: {
            id: "506a7b29-a9e2-43e4-a781-64db60bd1a69",
            name: "Alfred John",
            children: {},
            level: 2,
          },
          10: {
            id: "58acb9a0-87d1-4a9c-8e3a-4d28ca69feae",
            name: "John A. Makoto",
            children: {},
            level: 2,
          },
          11: {
            id: "dc45839f-2472-48d7-88af-29332a97046e",
            name: "F. Sherwood Samuel",
            children: {},
            level: 2,
          },
        },
      ...
      1: {
        id: "96983d42-193a-4b7f-93fb-40cd28a5a671",
        name: "Sir James W. Alfred G.",
        children: {
          0: {
            id: "6e3b6182-1a1d-4c89-98ca-af3f8f84a417",
            name: "Kofi Petrus (Peter) Josephus Wilhelmus",
            children: {
              0: {
                id: "6ae13bb9-8b27-4855-8873-a0a5b2343707",
                name: "Marie Eugene Paul",
                children: {},
                level: 3,
              },
              1: {
                id: "5153e275-9643-4fc2-8823-d70642731a14",
                name: "Ronald George Wreyford Fredrik",
                children: {},
                level: 3,
              },
              2: {
                id: "37e3a395-ffd2-4a3e-9e16-1146a766b16e",
                name: "Charles Brenton James M.",
                children: {},
                level: 3,
              },
              3: {
                id: "a5ef2230-6b70-4c2a-ae55-3b3d918a7ab1",
                name: "Robert J. Dickinson W.",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "d7681917-6ad7-4538-a578-7fae3792116f",
            name: "Edwin Mattison Philip Showalter",
            children: {
              0: {
                id: "93850d9e-a9b5-4990-88c5-f4c838cacfa5",
                name: "Gary S. Jean Baptiste",
                children: {},
                level: 3,
              },
              1: {
                id: "c8fa071f-f82d-4037-ab19-c4237a895674",
                name: "Takaaki Françoise",
                children: {},
                level: 3,
              },
              2: {
                id: "f376e9c5-a675-4200-bbe9-00d3180abf13",
                name: "Salvatore Donald J.",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "77bb34c3-10cb-4c46-ac95-dcb0ada8f426",
            name: "Rainer Gerald M.",
            children: {
              0: {
                id: "e5b9a059-bf51-48ef-98c1-823795820cb6",
                name: "Giorgos Gustav Ludwig",
                children: {},
                level: 3,
              },
              1: {
                id: "8b0c274f-a71d-415e-ba74-ac8e89eb34e8",
                name: "Tomas Tawakkol",
                children: {},
                level: 3,
              },
              2: {
                id: "e1bcd931-fd58-4818-a903-66109d38d7d9",
                name: "Cecil of Chelwood, Viscount Christiane",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "a6e7450a-4f25-458c-997d-4a6b8a354b2c",
            name: "Russell A. Daniel L.",
            children: {
              0: {
                id: "8ee7d77a-b669-4f71-b954-f0bcf7bab6dd",
                name: "Peyton Owen",
                children: {},
                level: 3,
              },
              1: {
                id: "2a051c8a-3693-4649-a899-8993e7b40bfe",
                name: "Otto Heinrich Vernon L.",
                children: {},
                level: 3,
              },
            },
          ...
          4: {
            id: "02b9ac7a-af5d-4561-8916-a021edbeafc5",
            name: "Johannes Andreas Grib Tomas",
            children: {
              0: {
                id: "a7957d3d-3e40-424d-b44b-281ddf8ab92e",
                name: "Seán Bjørnstjerne Martinus",
                children: {},
                level: 3,
              },
            },
          ...
          5: {
            id: "5f0a89a9-fb23-421a-9252-c49e5b012187",
            name: "Wislawa Har Gobind",
            children: {
              0: {
                id: "40a4a803-759d-4f08-a4ea-786475c09fb7",
                name: "Edward Adelbert Tim",
                children: {},
                level: 3,
              },
            },
          ...
          6: {
            id: "7809b706-f2a0-4f60-8a80-bee371aa1fed",
            name: "William S. Kenichi",
            children: {},
            level: 2,
          },
          7: {
            id: "364a46de-a1b5-4f1c-8fda-fa613a72847f",
            name: "Richard Martin Wilhelm Conrad",
            children: {},
            level: 2,
          },
          8: {
            id: "d94b2001-92cf-4d05-9698-c92c43ddd9ae",
            name: "Charles Thomson Rees Wilhelm",
            children: {},
            level: 2,
          },
          9: {
            id: "06cf808c-c3ee-4e85-abff-67509d8b5372",
            name: "Henrik Jean-Marie",
            children: {},
            level: 2,
          },
          10: {
            id: "17525112-8c20-41ae-b7ce-78ea95a061c8",
            name: "John R. Jack",
            children: {},
            level: 2,
          },
      ...
      2: {
        id: "43eb4a98-3546-4244-9aff-c10f7b0a10a4",
        name: "Torsten N. Gerhard",
        children: {
          0: {
            id: "d8ffbb89-6900-4268-8a94-57f923ca96e9",
            name: "William H. Malala",
            children: {
              0: {
                id: "aa109e9a-405f-4f4e-977b-fa051403b7b3",
                name: "Russell A. Henry",
                children: {},
                level: 3,
              },
              1: {
                id: "8c484b43-eac5-404e-9300-3fa7548f9224",
                name: "William Subramanyan",
                children: {},
                level: 3,
              },
              2: {
                id: "e15aaaf7-6fd8-4b96-9268-0640c3af2864",
                name: "Theodore Sir Howard Walter",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "ac5e4c24-260c-4bd9-a3bf-00cb3c6cc9bd",
            name: "Christian Matthias Theodor Georges J.F.",
            children: {
              0: {
                id: "4da9a56e-489f-404f-be62-a2a8bb555194",
                name: "George D. Philip Warren",
                children: {},
                level: 3,
              },
              1: {
                id: "e760fdce-65b7-45fc-8220-621121c33687",
                name: "George P. Riccardo",
                children: {},
                level: 3,
              },
              2: {
                id: "cdfc1b4c-54fd-4d26-b5b8-4efb396ff2ba",
                name: "Leopold Bob",
                children: {},
                level: 3,
              },
          ...
          2: {
            id: "996675d2-98a0-46c7-af61-0f8cba69b952",
            name: "Shmuel Yosef Liu",
            children: {
              0: {
                id: "72f0386c-1e25-46d6-b0e6-0a759de64dfb",
                name: "Susumu Thomas Woodrow",
                children: {},
                level: 3,
              },
              1: {
                id: "19e39d26-d638-4d6e-95b9-fe09e58cc1f3",
                name: "Ernest Orlando William Alfred",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "22b8ebf5-1a0d-41a3-993d-413758249844",
            name: "Masatoshi Edwin Mattison",
            children: {
              0: {
                id: "ce660269-bbdc-4f70-a788-25599c3b13c1",
                name: "James J. Max",
                children: {},
                level: 3,
              },
          ...
          4: {
            id: "cfa5f4a2-7898-4bd5-a90e-de5fba17be6b",
            name: "David J. Eric",
            children: {
              0: {
                id: "b6ad739d-3cfc-4227-9893-de9d5822f708",
                name: "Hartmut Robert J.",
                children: {},
                level: 3,
              },
            },
          ...
          5: {
            id: "badd4f29-86b0-4690-b4ad-6e82752661e4",
            name: "Georges J.F. Robert A.",
            children: {},
            level: 2,
          },
          6: {
            id: "b4fd54f2-ad54-42ea-9457-acfc03f3b550",
            name: "Johannes Diderik Lawrence R.",
            children: {},
            level: 2,
          },
          7: {
            id: "bd023e4b-22dd-4ef6-bc80-ab2d4e9a2f2a",
            name: "Ei-ichi Konrad",
            children: {},
            level: 2,
          },
          8: {
            id: "d7390926-97aa-4036-9e7c-be4968102134",
            name: "Robert Bruce Leo",
            children: {},
            level: 2,
          },
          9: {
            id: "5b39a8ba-6310-4da6-9f5a-fd877a038e77",
            name: "Stefan W. Mikhail Aleksandrovich",
            children: {},
            level: 2,
          },
        },
      ...
      3: {
        id: "127f2ba7-7baf-43c9-b92d-38feec544641",
        name: "Peter Wolfgang",
        children: {
          0: {
            id: "db2ac23d-c6a2-4e13-a293-194f554ca90a",
            name: "Antoine Henri Charles Jules Henri",
            children: {
              0: {
                id: "b4389dad-ea29-4649-8470-d9fc62eb862f",
                name: "Roald Pablo",
                children: {},
                level: 3,
              },
              1: {
                id: "dc57e8d7-3635-4f21-98e0-f70ecf7d31d7",
                name: "James F. Sherwood",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "6c2e614a-f826-456f-a076-ea007428caf6",
            name: "Sidney Willard S.",
            children: {
              0: {
                id: "c3b80799-142e-4c6b-abfe-1bdcadb328a5",
                name: "Sir Vidiadhar Surajprasad Andrew V.",
                children: {},
                level: 3,
              },
              1: {
                id: "f476d024-4b23-41c0-84d7-920a2effc3d7",
                name: "National Dialogue Quartet Eric S.",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "9497a148-b450-4c28-b9f8-985ae27d884a",
            name: "James E. Paul J.",
            children: {
              0: {
                id: "8866497d-63c7-4ed3-a51c-5b260e27b91a",
                name: "Gunnar Giulio",
                children: {},
                level: 3,
              },
          ...
          3: {
            id: "3bec31f2-911a-476b-bbf9-6dd936ba2e66",
            name: "Herbert A. George",
            children: {
              0: {
                id: "3051ea3a-c2e7-4b9b-9eab-b37e13470969",
                name: "Philip Warren Yoshinori",
                children: {},
                level: 3,
              },
            },
          ...
          4: {
            id: "df297f04-c60c-4419-aee2-fc5de4647d14",
            name: "Walter Baruch S.",
            children: {},
            level: 2,
          },
          5: {
            id: "fefa84c7-f463-4538-bbf2-69c559165469",
            name: "Sir Austen K. Barry",
            children: {},
            level: 2,
          },
          6: {
            id: "0491d8a3-c4f5-4b9c-a062-65606b19cda5",
            name: "Barbara Ludwig",
            children: {},
            level: 2,
          },
          7: {
            id: "e6cd8506-84b1-4c38-a0d0-14eef91b33fc",
            name: "Bengt Peyton",
            children: {},
            level: 2,
          },
          8: {
            id: "b4a6ea78-546b-4c18-af53-4049064623a2",
            name: "Alan G. Barbara",
            children: {},
            level: 2,
          },
      ...
      4: {
        id: "af27f4ac-0ff6-4b61-becf-800bc50fa58d",
        name: "Roger Allvar",
        children: {
          0: {
            id: "9a6efd0c-2fac-40cd-8ac1-d1e3832d41c5",
            name: "Riccardo Friedrich August",
            children: {
              0: {
                id: "619e8f2e-87b9-400d-951c-e4fbab296cf1",
                name: "Wendell Meredith Liu",
                children: {},
                level: 3,
              },
              1: {
                id: "c92f6dc1-258c-4003-9718-f33fd50301ae",
                name: "Christopher A. Andrew V.",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "1c6b1b54-9a15-466f-8705-0abd2b08365d",
            name: "Niels K. Frances H.",
            children: {
              0: {
                id: "2ac9bb65-5b25-49ee-8bf0-375ec49ed3e3",
                name: "Frances H. Ernst Boris",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "b320129a-3241-4e91-af86-92fd50439438",
            name: "Nelson Hans Adolf",
            children: {
              0: {
                id: "5db055fd-3c1b-42e4-9174-996c1de7ba14",
                name: "Carl Ferdinand Herbert",
                children: {},
                level: 3,
              },
            },
          ...
          3: {
            id: "a11da1dd-e681-4d42-97e3-ecfdce3101f6",
            name: "Milton Dan",
            children: {},
            level: 2,
          },
          4: {
            id: "ee0ad305-bc9c-4cef-a2ab-efbaa2814a64",
            name: "Carl Gustaf Verner Daniel",
            children: {},
            level: 2,
          },
          5: {
            id: "f6395b98-5fe8-4144-ac11-15bbc2e7550f",
            name: "Muhammad Artturi Ilmari",
            children: {},
            level: 2,
          },
          6: {
            id: "a499b184-1782-43c3-82ee-58e0feb51e3e",
            name: "Christian Matthias Theodor Martin",
            children: {},
            level: 2,
          },
          7: {
            id: "43da4399-3fab-4c7e-b2e2-93360e271035",
            name: "Eric S. Joachim",
            children: {},
            level: 2,
          },
      ...
      5: {
        id: "2633c9cd-ed81-4c47-a254-2ae571a07465",
        name: "Leonid Sir James W.",
        children: {
          0: {
            id: "df350335-387e-4334-8538-db635d0dccdd",
            name: "Richard R. Richard Laurence Millington",
            children: {
              0: {
                id: "02fd887a-de1c-4a36-9f02-1064739c30e8",
                name: "William E. D. Carleton",
                children: {},
                level: 3,
              },
            },
          ...
          1: {
            id: "809b762e-0b1f-4337-8213-4f72875c36fe",
            name: "Hans Desmond Mpilo",
            children: {
              0: {
                id: "a4106bc9-ab6e-4245-b821-8da461982e15",
                name: "Satoshi F. Duncan M.",
                children: {},
                level: 3,
              },
            },
          ...
          2: {
            id: "36ec133d-ec75-4c5f-af18-424c349de4d7",
            name: "William E. Heinrich Otto",
            children: {
              0: {
                id: "4fea3cac-ef89-487e-ad5d-c67bf0811376",
                name: "Kim François",
                children: {},
                level: 3,
              },
          ...
          3: {
            id: "904d2cf3-953f-4a9e-a4af-e8dc1b5e0eb1",
            name: "John Cowdery André Paul Guillaume",
            children: {},
            level: 2,
          },
          4: {
            id: "ad28c993-62db-4806-87fd-cf686cefca64",
            name: "Archibald Vivian Léon Victor Auguste",
            children: {},
            level: 2,
          },
          5: {
            id: "b85d173a-8f16-4379-b0df-257a0fe3e48b",
            name: "Harry M. Baroness Bertha Sophie Felicita",
            children: {},
            level: 2,
          },
          6: {
            id: "ad52e56f-828f-4bab-87b8-8c4da21587c7",
            name: "Yuan T. Melvin",
            children: {},
            level: 2,
          },
      ...
      6: {
        id: "0f65a126-ada1-4a02-be9a-3925f161d389",
        name: "May-Britt Richard",
        children: {
          0: {
            id: "d89a13e0-385e-452d-8d99-90248a5d71a0",
            name: "Pearl William C.",
            children: {
              0: {
                id: "f500b01a-d746-41e9-aac8-132802638fe5",
                name: "Carlo Alfred D.",
                children: {},
                level: 3,
              },
          ...
          1: {
            id: "fcead790-5b4f-417f-aa21-142eb41e3ed6",
            name: "Shinya Robert J.",
            children: {},
            level: 2,
          },
          2: {
            id: "86f28a9e-36c5-4071-b129-aaf3ea296964",
            name: "Geoffrey Theodore",
            children: {},
            level: 2,
          },
          3: {
            id: "6366cabd-d291-4b2b-8d16-bff0a477bff7",
            name: "Oliver E. Leon Neil",
            children: {},
            level: 2,
          },
          4: {
            id: "9033448d-6dbe-42f8-a246-2efdec2b9655",
            name: "José Albert John",
            children: {},
            level: 2,
          },
          5: {
            id: "2c805fc4-1a0e-46fb-b833-05532d26633c",
            name: "Dickinson W. Richard",
            children: {},
            level: 2,
          },
        },
      ...
      7: {
        id: "84c0a73f-eec7-45c4-88f6-fcbf7570b9e5",
        name: "Karl Manne Georg François",
        children: {
          0: {
            id: "3d11dd48-1783-4c34-8eb0-c8f50caa6866",
            name: "Grameen Bank André Frédéric",
            children: {
              0: {
                id: "fd547f48-aa3d-44cd-85ec-13af6e70799f",
                name: "Pearl Georges",
                children: {},
                level: 3,
              },
          ...
          1: {
            id: "ed65f3d7-d0a6-41c5-84cc-d9c1d975af67",
            name: "Leon M. Bengt",
            children: {},
            level: 2,
          },
          2: {
            id: "f13ba6d8-3792-4f01-a9f4-e0c168423388",
            name: "Nicholas Murray Rigoberta",
            children: {},
            level: 2,
          },
          3: {
            id: "19f610cc-1f13-4bbb-83b7-7962a97712b6",
            name: "Herta Karl",
            children: {},
            level: 2,
          },
          4: {
            id: "7196f68f-736d-494c-816d-9dcb5403cc5e",
            name: "Christiaan Erwin",
            children: {},
            level: 2,
          },
        },
      ...
      8: {
        id: "1fc18c29-db23-405b-ae1c-f398ae77d298",
        name: "Hideki Jacques",
        children: {
          0: {
            id: "2e73874a-7668-48f0-b3b6-be9d48bfc179",
            name: "Herbert C. Milton",
            children: {},
            level: 2,
          },
          1: {
            id: "f7cb57e9-5fdc-4913-9b09-815216c3b2f2",
            name: "Joseph E. Edward Calvin",
            children: {},
            level: 2,
          },
          2: {
            id: "c838b0a5-5d33-48e2-bc5d-3b888ffdac18",
            name: "Julian Albert Abraham",
            children: {},
            level: 2,
          },
          3: {
            id: "9d5995cf-583a-4b75-a147-59ca91efb08b",
            name: "Guglielmo Mario R.",
            children: {},
            level: 2,
          },
        },
      ...
      9: {
        id: "f90c63f9-4a83-4b24-b2c0-3dcfc1b2453f",
        name: "Nelson Ivo",
        children: {
          0: {
            id: "63b840a9-02e0-4d19-b69e-0b7f54b21253",
            name: "Giosuè François",
            children: {},
            level: 2,
          },
          1: {
            id: "a3eb570b-fb75-4a89-a989-e04e6258d83f",
            name: "Igor Yevgenyevich William",
            children: {},
            level: 2,
          },
          2: {
            id: "6c702000-be46-4f1e-b022-52b45b9ff25e",
            name: "Philipp Eduard Anton Albert Abraham",
            children: {},
            level: 2,
          },
        },
      ...
      10: {
        id: "2bb5ee06-a803-47b5-bf73-cd03eaf36722",
        name: "John A. Harold E.",
        children: {
          0: {
            id: "6e9d805f-27a9-4a37-b84d-c78ab456e6b2",
            name: "Willy Ilya",
            children: {},
            level: 2,
          },
          1: {
            id: "88e96c41-418b-43dc-8706-e6d68d56e45c",
            name: "Cordell Sir J. Fraser",
            children: {},
            level: 2,
          },
          2: {
            id: "6aa3210f-d29f-4aa7-b6f8-76986a1fd3c5",
            name: "Michael W. Alva",
            children: {},
            level: 2,
          },
      ...
      11: {
        id: "7fd1e875-92b2-4e34-bf72-02f298193035",
        name: "Sir Howard Walter Joseph",
        children: {
          0: {
            id: "46b4bbd4-1b38-4bf0-b875-3fed7be6fa35",
            name: "Thomas R. Alfred Hermann",
            children: {},
            level: 2,
          },
          1: {
            id: "dac89d41-2b93-4f80-a758-694e8681a6c1",
            name: "Gerardus Johannes Diderik",
            children: {},
            level: 2,
          },
        },
      ...
      12: {
        id: "f7f668ca-ffeb-449e-b32a-e8fd6bac966d",
        name: "Jack W. Erik Axel",
        children: {
          0: {
            id: "6d0260fc-0fc3-4039-9cdf-ef5b4f54f7ca",
            name: "Clinton Joseph Maurice",
            children: {},
            level: 2,
          },
        },
      ...
      13: {
        id: "12c442ad-275f-4cc0-a06f-c15acb25b4f8",
        name: "Har Gobind Odysseus",
        children: {
          0: {
            id: "092709fc-d20d-436f-aaef-be6d126bee96",
            name: "Joachim Sin-Itiro",
            children: {},
            level: 2,
          },
        },
      ...
      14: {
        id: "d95296ab-0ab9-4618-9418-bec1210b17b5",
        name: "Gérard Joseph",
        children: {},
        level: 1,
      },
      15: {
        id: "14483c9e-35f8-4c26-844f-d7bdbcb0e9ef",
        name: "George E. Julian",
        children: {},
        level: 1,
      },
      16: {
        id: "36072253-72a7-4897-9f73-33c7c90b0b94",
        name: "Douglas D. Melvin",
        children: {},
        level: 1,
      },
      17: {
        id: "813c5abe-54dd-405b-b570-8bd7d7c854ee",
        name: "Sir J. Fraser Rosalyn",
        children: {},
        level: 1,
      },
      18: {
        id: "f9798d55-0090-47de-97b5-fd63bd51fea8",
        name: "Joseph E. Leland H.",
        children: {},
        level: 1,
      },
    },
